def llista_coincidencies(trip_id):
    ...
    return llista, llista_data

def gustos(trip_id):
    coin = {}
    llista, llista_data = llista_coincidencies(trip_id)
    ...
    return sort_coin, llista_data


def coincidencias_orden(trip_id):

    llista, llista_data = gustos(trip_id)
